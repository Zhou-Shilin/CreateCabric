...
public class ModFoods {
    ...
    public static final FoodProperties REGEN_DRINK = (new FoodProperties.Builder())
            .effect(() -> new MobEffectInstance(MobEffects.REGENERATION, CafeConfig.effectDuration * 20, 1), 1.0F)
    ...
    public static final FoodProperties FIRE_RES = (new FoodProperties.Builder())
            .effect(() -> new MobEffectInstance(MobEffects.FIRE_RESISTANCE, CafeConfig.effectDuration * 20, 1), 1.0F)
            .nutrition(8).saturationModifier(0.2F).alwaysEdible().build();

    public static final FoodProperties RES_DRINK = (new FoodProperties.Builder())
            .effect(() -> new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, CafeConfig.effectDuration * 20, 0), 1.0F)
            .nutrition(8).saturationModifier(0.2F).alwaysEdible().build();

    public static final FoodProperties SPEED_DRINK = (new FoodProperties.Builder())
            .effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, CafeConfig.effectDuration * 20, 1), 1.0F)
            .nutrition(8).saturationModifier(0.2F).alwaysEdible().build();

    public static final FoodProperties STRENGTH_DRINK = (new FoodProperties.Builder())
            .effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, CafeConfig.effectDuration * 20, 1), 1.0F)
            .nutrition(8).saturationModifier(0.2F).alwaysEdible().build();

    public static final FoodProperties SUPER_DRINK = (new FoodProperties.Builder())
            .effect(() -> new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, CafeConfig.effectDuration * 20, 1), 1.0F)
            .effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, CafeConfig.effectDuration * 20, 1), 1.0F)
            .effect(() -> new MobEffectInstance(MobEffects.ABSORPTION, CafeConfig.effectDuration * 20, 1), 1.0F)
            .effect(() -> new MobEffectInstance(MobEffects.REGENERATION, CafeConfig.effectDuration * 20, 1), 1.0F)
            .effect(() -> new MobEffectInstance(MobEffects.FIRE_RESISTANCE, CafeConfig.effectDuration * 20, 1), 1.0F)
            .nutrition(8).saturationModifier(0.2F).alwaysEdible().build();

    public static final FoodProperties ICED_COFFEE_DRINK = new FoodProperties.Builder()
            .effect(() -> new MobEffectInstance(EffectRegistry.CAFFINATED, CafeConfig.effectDuration * 20, 3), 1.0F).alwaysEdible().build();
    public static final Function<Holder<MobEffect>, FoodProperties> ICED_COFFEE_DRINK_FLAVOR = (effect -> (new FoodProperties.Builder())
            .effect(() -> new MobEffectInstance(EffectRegistry.CAFFINATED, CafeConfig.effectDuration * 20, 1), 1.0F)
            .effect(() -> new MobEffectInstance(effect, CafeConfig.effectDuration * 20, 1), 1.0F)
            .nutrition(8).saturationModifier(0.2F).alwaysEdible().build());
}
